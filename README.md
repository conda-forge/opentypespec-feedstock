...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentypespec-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentypespec-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentypespec
# for installing globally
pixi global install opentypespec
```
...
It is possible to list all of the versions of `opentypespec` available on your platform:
...
```
pixi search opentypespec --channel conda-forge
```
